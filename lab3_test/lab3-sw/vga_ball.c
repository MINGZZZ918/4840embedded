...
{
	iowrite8((unsigned char)(((position->x) >>8) &0b11), CIR_XH(dev.virtbase) );
	iowrite8((unsigned char)(position->x), CIR_XL(dev.virtbase) );
	iowrite8((unsigned char)(((position->y) >>8) &0b11), CIR_YH(dev.virtbase) );
	iowrite8((unsigned char)(position->y), CIR_YL(dev.virtbase) );
