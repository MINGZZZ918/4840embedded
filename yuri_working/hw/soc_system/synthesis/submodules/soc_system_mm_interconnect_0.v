...
module soc_system_mm_interconnect_0 (
		...
		output wire [7:0]  rom_sprites_s1_address,                                              //                                                rom_sprites_s1.address
		output wire        rom_sprites_s1_write,                                                //                                                              .write
		input  wire [31:0] rom_sprites_s1_readdata,                                             //                                                              .readdata
		output wire [31:0] rom_sprites_s1_writedata,                                            //                                                              .writedata
		output wire [3:0]  rom_sprites_s1_byteenable,                                           //                                                              .byteenable
		output wire        rom_sprites_s1_chipselect,                                           //                                                              .chipselect
		output wire        rom_sprites_s1_clken,                                                //                                                              .clken
		output wire        rom_sprites_s1_debugaccess,                                          //                                                              .debugaccess
	...
	wire   [31:0] rom_sprites_s1_agent_m0_readdata;                              // rom_sprites_s1_translator:uav_readdata -> rom_sprites_s1_agent:m0_readdata
	wire          rom_sprites_s1_agent_m0_waitrequest;                           // rom_sprites_s1_translator:uav_waitrequest -> rom_sprites_s1_agent:m0_waitrequest
	wire          rom_sprites_s1_agent_m0_debugaccess;                           // rom_sprites_s1_agent:m0_debugaccess -> rom_sprites_s1_translator:uav_debugaccess
	wire   [20:0] rom_sprites_s1_agent_m0_address;                               // rom_sprites_s1_agent:m0_address -> rom_sprites_s1_translator:uav_address
	wire    [3:0] rom_sprites_s1_agent_m0_byteenable;                            // rom_sprites_s1_agent:m0_byteenable -> rom_sprites_s1_translator:uav_byteenable
	wire          rom_sprites_s1_agent_m0_read;                                  // rom_sprites_s1_agent:m0_read -> rom_sprites_s1_translator:uav_read
	wire          rom_sprites_s1_agent_m0_readdatavalid;                         // rom_sprites_s1_translator:uav_readdatavalid -> rom_sprites_s1_agent:m0_readdatavalid
	wire          rom_sprites_s1_agent_m0_lock;                                  // rom_sprites_s1_agent:m0_lock -> rom_sprites_s1_translator:uav_lock
	wire   [31:0] rom_sprites_s1_agent_m0_writedata;                             // rom_sprites_s1_agent:m0_writedata -> rom_sprites_s1_translator:uav_writedata
	wire          rom_sprites_s1_agent_m0_write;                                 // rom_sprites_s1_agent:m0_write -> rom_sprites_s1_translator:uav_write
	wire    [2:0] rom_sprites_s1_agent_m0_burstcount;                            // rom_sprites_s1_agent:m0_burstcount -> rom_sprites_s1_translator:uav_burstcount
	wire          rom_sprites_s1_agent_rf_source_valid;                          // rom_sprites_s1_agent:rf_source_valid -> rom_sprites_s1_agent_rsp_fifo:in_valid
	wire  [112:0] rom_sprites_s1_agent_rf_source_data;                           // rom_sprites_s1_agent:rf_source_data -> rom_sprites_s1_agent_rsp_fifo:in_data
	wire          rom_sprites_s1_agent_rf_source_ready;                          // rom_sprites_s1_agent_rsp_fifo:in_ready -> rom_sprites_s1_agent:rf_source_ready
	wire          rom_sprites_s1_agent_rf_source_startofpacket;                  // rom_sprites_s1_agent:rf_source_startofpacket -> rom_sprites_s1_agent_rsp_fifo:in_startofpacket
	wire          rom_sprites_s1_agent_rf_source_endofpacket;                    // rom_sprites_s1_agent:rf_source_endofpacket -> rom_sprites_s1_agent_rsp_fifo:in_endofpacket
	wire          rom_sprites_s1_agent_rsp_fifo_out_valid;                       // rom_sprites_s1_agent_rsp_fifo:out_valid -> rom_sprites_s1_agent:rf_sink_valid
	wire  [112:0] rom_sprites_s1_agent_rsp_fifo_out_data;                        // rom_sprites_s1_agent_rsp_fifo:out_data -> rom_sprites_s1_agent:rf_sink_data
	wire          rom_sprites_s1_agent_rsp_fifo_out_ready;                       // rom_sprites_s1_agent:rf_sink_ready -> rom_sprites_s1_agent_rsp_fifo:out_ready
	wire          rom_sprites_s1_agent_rsp_fifo_out_startofpacket;               // rom_sprites_s1_agent_rsp_fifo:out_startofpacket -> rom_sprites_s1_agent:rf_sink_startofpacket
	wire          rom_sprites_s1_agent_rsp_fifo_out_endofpacket;                 // rom_sprites_s1_agent_rsp_fifo:out_endofpacket -> rom_sprites_s1_agent:rf_sink_endofpacket
	wire          rom_sprites_s1_agent_rdata_fifo_src_valid;                     // rom_sprites_s1_agent:rdata_fifo_src_valid -> rom_sprites_s1_agent_rdata_fifo:in_valid
	wire   [33:0] rom_sprites_s1_agent_rdata_fifo_src_data;                      // rom_sprites_s1_agent:rdata_fifo_src_data -> rom_sprites_s1_agent_rdata_fifo:in_data
	wire          rom_sprites_s1_agent_rdata_fifo_src_ready;                     // rom_sprites_s1_agent_rdata_fifo:in_ready -> rom_sprites_s1_agent:rdata_fifo_src_ready
	...
	wire          rom_sprites_s1_agent_rp_valid;                                 // rom_sprites_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] rom_sprites_s1_agent_rp_data;                                  // rom_sprites_s1_agent:rp_data -> router_003:sink_data
	wire          rom_sprites_s1_agent_rp_ready;                                 // router_003:sink_ready -> rom_sprites_s1_agent:rp_ready
	wire          rom_sprites_s1_agent_rp_startofpacket;                         // rom_sprites_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          rom_sprites_s1_agent_rp_endofpacket;                           // rom_sprites_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> rom_sprites_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> rom_sprites_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                         // rom_sprites_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> rom_sprites_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> rom_sprites_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> rom_sprites_s1_burst_adapter:sink0_endofpacket
	wire          rom_sprites_s1_burst_adapter_source0_valid;                    // rom_sprites_s1_burst_adapter:source0_valid -> rom_sprites_s1_agent:cp_valid
	wire  [111:0] rom_sprites_s1_burst_adapter_source0_data;                     // rom_sprites_s1_burst_adapter:source0_data -> rom_sprites_s1_agent:cp_data
	wire          rom_sprites_s1_burst_adapter_source0_ready;                    // rom_sprites_s1_agent:cp_ready -> rom_sprites_s1_burst_adapter:source0_ready
	wire    [1:0] rom_sprites_s1_burst_adapter_source0_channel;                  // rom_sprites_s1_burst_adapter:source0_channel -> rom_sprites_s1_agent:cp_channel
	wire          rom_sprites_s1_burst_adapter_source0_startofpacket;            // rom_sprites_s1_burst_adapter:source0_startofpacket -> rom_sprites_s1_agent:cp_startofpacket
	wire          rom_sprites_s1_burst_adapter_source0_endofpacket;              // rom_sprites_s1_burst_adapter:source0_endofpacket -> rom_sprites_s1_agent:cp_endofpacket
	...
	wire          rom_sprites_s1_agent_rdata_fifo_out_valid;                     // rom_sprites_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] rom_sprites_s1_agent_rdata_fifo_out_data;                      // rom_sprites_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          rom_sprites_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_001:in_0_ready -> rom_sprites_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                             // avalon_st_adapter_001:out_0_valid -> rom_sprites_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                              // avalon_st_adapter_001:out_0_data -> rom_sprites_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                             // rom_sprites_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                             // avalon_st_adapter_001:out_0_error -> rom_sprites_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) rom_sprites_s1_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (vga_ball_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rom_sprites_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (rom_sprites_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (rom_sprites_s1_agent_m0_read),                 //                         .read
		.uav_write              (rom_sprites_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (rom_sprites_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (rom_sprites_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (rom_sprites_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (rom_sprites_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (rom_sprites_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (rom_sprites_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (rom_sprites_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (rom_sprites_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (rom_sprites_s1_write),                         //                         .write
		.av_readdata            (rom_sprites_s1_readdata),                      //                         .readdata
		.av_writedata           (rom_sprites_s1_writedata),                     //                         .writedata
		.av_byteenable          (rom_sprites_s1_byteenable),                    //                         .byteenable
		.av_chipselect          (rom_sprites_s1_chipselect),                    //                         .chipselect
		.av_clken               (rom_sprites_s1_clken),                         //                         .clken
		.av_debugaccess         (rom_sprites_s1_debugaccess),                   //                         .debugaccess
		.av_read                (),                                             //              (terminated)
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) rom_sprites_s1_agent (
		.clk                     (clk_0_clk_clk),                                      //             clk.clk
		.reset                   (vga_ball_0_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (rom_sprites_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (rom_sprites_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (rom_sprites_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (rom_sprites_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (rom_sprites_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (rom_sprites_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (rom_sprites_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (rom_sprites_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (rom_sprites_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (rom_sprites_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (rom_sprites_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (rom_sprites_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (rom_sprites_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (rom_sprites_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (rom_sprites_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (rom_sprites_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (rom_sprites_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (rom_sprites_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (rom_sprites_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (rom_sprites_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (rom_sprites_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (rom_sprites_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (rom_sprites_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (rom_sprites_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (rom_sprites_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (rom_sprites_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (rom_sprites_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (rom_sprites_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (rom_sprites_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (rom_sprites_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (rom_sprites_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (rom_sprites_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                  // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                  //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                   //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                  //                .error
		.rdata_fifo_src_ready    (rom_sprites_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rom_sprites_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (rom_sprites_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                              //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rom_sprites_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (vga_ball_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (rom_sprites_s1_agent_rf_source_data),             //        in.data
		.in_valid          (rom_sprites_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (rom_sprites_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rom_sprites_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rom_sprites_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rom_sprites_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rom_sprites_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rom_sprites_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rom_sprites_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rom_sprites_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rom_sprites_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (vga_ball_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (rom_sprites_s1_agent_rdata_fifo_src_data),     //        in.data
		.in_valid          (rom_sprites_s1_agent_rdata_fifo_src_valid),    //          .valid
		.in_ready          (rom_sprites_s1_agent_rdata_fifo_src_ready),    //          .ready
		.out_data          (rom_sprites_s1_agent_rdata_fifo_out_data),     //       out.data
		.out_valid         (rom_sprites_s1_agent_rdata_fifo_out_valid),    //          .valid
		.out_ready         (rom_sprites_s1_agent_rdata_fifo_out_ready),    //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	soc_system_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (rom_sprites_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (rom_sprites_s1_agent_rp_valid),                //          .valid
		.sink_data          (rom_sprites_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (rom_sprites_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (rom_sprites_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (vga_ball_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (rom_sprites_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (rom_sprites_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (rom_sprites_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (rom_sprites_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (rom_sprites_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (rom_sprites_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (vga_ball_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (rom_sprites_s1_agent_rdata_fifo_out_data),     //     in_0.data
		.in_0_valid     (rom_sprites_s1_agent_rdata_fifo_out_valid),    //         .valid
		.in_0_ready     (rom_sprites_s1_agent_rdata_fifo_out_ready),    //         .ready
